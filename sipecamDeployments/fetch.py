...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Get kobo deployments and match zendro information from SiPeCaM surveys. The following environtmental variables should be declared in order to get the result: "KOBO_URL", "KOBO_USER", "KOBO_PASSWORD", "ZENDRO_URL", "ZENDRO_USER", "ZENDRO_PASSWORD"')
